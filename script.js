const translations = {
    ...
    es: {
        ...
        "about-desc": "Creo experiencias web interactivas, atractivas y con animaciones fluidas. Creo que la web debe ser divertida, dinámica y llena de vida.",
        "card1-title": "Diseño",
        "card1-desc": "Creación de interfaces hermosas y centradas en el usuario.",
        "card2-title": "Desarrollo",
        "card2-desc": "Código limpio y eficiente en HTML, CSS y JavaScript.",
        "card3-title": "Animación",
        "card3-desc": "Dando vida a páginas estáticas a través del movimiento.",
        "contact-title": "Contacto",
        "contact-desc": "¡No dudes en contactarme si tienes alguna pregunta!",
        "guestbook-title": "Libro de visitas",
        "guestbook-desc": "¡Deja un mensaje! No es necesario iniciar sesión.",
    ...
    ru: {
        ...
        "hero-hello": "Привет, я ",
        "hero-name-suffix": "",
        "hero-subtitle": "Дизайнер и Frontend-разработчик",
        "hero-btn": "Смотреть портфолио",
        "about-title": "Обо мне",
        "about-desc": "Я создаю интерактивные и живые веб-интерфейсы. Верю, что веб-пространство должно быть увлекательным, плавным и полным жизни.",
        "card1-title": "Дизайн",
        "card1-desc": "Создание эстетичных интерфейсов для пользователей.",
        "card2-title": "Разработка",
        "card2-desc": "Чистый и эффективный код на HTML, CSS и JS.",
        "card3-title": "Анимация",
        "card3-desc": "Оживляю статические страницы с помощью движения.",
        "contact-title": "Контакты",
        "contact-desc": "Свяжитесь со мной, если у вас есть вопросы!",
        "guestbook-title": "Гостевая книга",
        "guestbook-desc": "Оставьте сообщение! Регистрация не требуется.",
